...
class eModulus_mainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #Load the UI Page
        uic.loadUi(r'GUI/eModulus_mainwindow.ui', self)
        
        #Define global properties with default values
        #These values may be used as reference for validating user inputs
        self.pathForFile=r'D:/Users/renan/OneDrive/Renan/Engenharia Civil/Artigos/2023-ToBeDefined-EMMARM metrologico/3-SECOND_ATTEMPT/0-EXPERIMENTAL_DATA/BATCH_2/EMMARM/National-1_Frequency_SSI.txt'
    ...
    def openFilePathDialog(self):
        ...
        if selected_file_path and selected_file_path.endswith("txt"):
            ...
            print("Selected file:", selected_file_path) if debugActivated else None   
        else:
    ...
    def update_testDescription(self, new_value):
        ...
        print(self.testDescription) if debugActivated else None 
    def update_ageAtBeginningOfTest(self, new_value):
        ...
        print(self.ageAtBeginningOfTest) if debugActivated else None   
    def update_massOfEmptyTube(self, new_value):
        ...
        print(self.massOfEmptyTube) if debugActivated else None   
    def update_internalTubeDiameter(self, new_value):
        ...
        print(self.internalTubeDiameter) if debugActivated else None   
    def update_externalTubeDiameter(self, new_value):
        ...
        print(self.externalTubeDiameter) if debugActivated else None   
    def update_totalLengthOfTube(self, new_value):
        ...
        print(self.totalLengthOfTube) if debugActivated else None   
    def update_freeCantileverLength(self, new_value):
        ...
        print(self.freeCantileverLength) if debugActivated else None   
    def update_massOfFilledTube(self, new_value):
        ...
        print(self.massOfFilledTube) if debugActivated else None   
    def update_massAtTip(self, new_value):
        try:
            ...
            #Expection to deal with when the field is
            self.massAtTip=None
        print(self.massAtTip) if debugActivated else None 
    def update_freeCantileverLengthEmptyTube(self, new_value):
        ...
        print(self.freeCantileverLengthEmptyTube) if debugActivated else None 
    def update_massAtTipEmptyTube(self, new_value):
        ...
        print(self.massAtTipEmptyTube) if debugActivated else None 
    def update_frequencyEmptyTube(self, new_value):
        ...
        print(self.frequencyEmptyTube) if debugActivated else None 
    def update_dormantAgeThreshold(self, new_value):
        try:
            ...
            #Expection to deal with when the field is
            self.dormantAgeThreshold=None
        print(self.dormantAgeThreshold) if debugActivated else None 
    ...
    def updateGraphs(self, plotToUpdate=None):
        ...
        if plotToUpdate == 0:
            try:
                ...
                self.ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.18),
                        fancybox=False, columnspacing=0.2, ncol=1)
